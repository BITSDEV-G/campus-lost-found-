    ...
    return (
        <div className="min-h-screen flex flex-col">
            <Helmet>
                ...
                <meta name="description" content="Frequently asked questions about Zetech Lost & Found. Find answers about reporting items, security, claiming items, and notifications." />
            </Helmet>
